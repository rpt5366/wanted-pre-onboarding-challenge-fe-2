## Introduction
안녕하세요, 최근 프론트 웹 개발에 관심이 생겨, 틈틈이 React.js를 공부하고 있습니다. 대학생 취업준비생일 때도 기본적인 프론트 웹 개발(HTML, CSS, Javascript) 공부를 했었고, WebGL API를 사용하여 간단한 웹 비행 게임 어플리케이션 구현에 참여한 경험이 있습니다. 시각적인 부분을 개발하는 것이 재미있어 신청하게 되었습니다. 특히 Typescript가 피할 수 없는 하나의 대세이고, 점차 많은 코드들이 Typescript로 작성되고 있다는 트렌드를 감안할 때, Typescript 공부의 필요성을 느꼈습니다. 이번 챌린지가 좋은 프론트 개발 역량 향상에 도움이 되어 커리어로 이어지면 좋겠습니다. 감사합니다. 
