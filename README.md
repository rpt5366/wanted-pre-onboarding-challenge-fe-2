...
## 자기소개
안녕하세요, 프론트엔드 개발에 관심이 많은 송형섭입니다. WebGL API를 활용한 비행기 웹 게임 애플리케이션 개발에 참여한 경험, Node.js, MongoDB, React를 활용한 로그인 & 회원가입 개발 경험이 있습니다. 프론트엔드 지식을 넓히기 위해 평소 HTML, CSS, JS 및 React를 공부하고 있고, 최근 우대사항 기술로 자주 언급되는 Typescript 공부에 도전하여 실전에서도 응용해 보고 싶어 지원하게 되었습니다. 이번 챌린지 참여를 통해 Typescript와 프론트엔드 개발에 대한 이해를 심화하고, 이후 프론트개발 커리어로도 이어졌으면 좋겠습니다. 감사합니다.
