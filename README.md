...
최근 프론트에서 시각적인 부분을 개발하는 것이 재미있어 신청하게 되었습니다. 평소 틈틈이 React.js를 공부하고 있고, 취업준비를 할 때 기본적인 기본 프론트(HTML, CSS, Javascript) 공부를 했었습니다. 또한 학부생 때는 WebGL API를 사용하여 간단한 웹 비행 게임 어플리케이션 구현에 참여한 경험도 있습니다. 근래에 Typescript가 피할 수 없는 하나의 대세이고, 점차 많은 코드들이 Typescript로 작성되고 있다는 점, 많은 구인공고에서 Typescript를 요한다는 점에서 Typescript 공부의 필요성을 느꼈습니다. 이번 챌린지를 통해 Typescript를 배우고 커리어로 이어지면 좋겠습니다 :) 
